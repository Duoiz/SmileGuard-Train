...
#
# Roboflow-dataset has the same 4 base classes — no new classes to add.
...
# Roboflow-dataset: 0=Caries, 1=Cavity, 2=Crack, 3=Tooth
ROBOFLOW_TO_MERGED = {
    0: 1,   # Caries → caries
    1: 2,   # Cavity → cavity
    2: 3,   # Crack  → crack
...
TRIM_TARGETS = {
    0: 4000,   # tooth   — was ~22,731 total (will grow further after Roboflow merge)
